...
use crate::elf::{
    class::{AdditiveIdentity, ClassParse, ClassParseBase, MultiplicativeIdentity},
...
impl<'slice, C: ClassParse, E: EncodingParse> ProgramHeader<'slice, C, E> {
    ...
    pub fn validate_specification(&self) -> Result<(), ValidateProgramHeaderSpecError> {
        ...
        let zero = <C::ClassUsize as AdditiveIdentity>::ADDITIVE_IDENTITY;
        let one = <C::ClassUsize as MultiplicativeIdentity>::MULTIPLICATIVE_IDENTITY;
