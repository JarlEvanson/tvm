//! Interfaces providing graphical manipulation for `tvm_loader`.
//!
...
pub mod font {
    ...
    pub const FONT_MAP: FontMap = {
        ...
        /// Function to align a series of bytes to another item's alignment.
        #[repr(C)]
        struct Aligned<A, T: ?Sized> {
            /// Zero-sized alignment field.
            aligner: [A; 0],
            /// The [`Sized`] value that [`Aligned`] wraps.
            value: T,
        }

        // SAFETY:
        //
        // [`FONT_MAP_BYTES`] is properly aligned and of the correct length.
